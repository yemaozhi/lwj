...
;(function(){
   'use strict';
    ...
    $validate.loadHost=function(){
        ...
        loadJS.src="messages_zh.js";
        head.appendChild(loadJS);
    };
    //表单验证方法
    ...
    /**
     * 手动注册validate验证
     * @param params 自定义错误信息容器,若没有则使用默认样式
     * eg:$("#form").formValidate({errorElement:"p",errorClass:"error"})
     *    errorElement:错误信息元素容器
     *    errorClass:为错误信息添加类名
     */
    $.fn.formValidate=function(params){
        $validate.validateInit($(this),params);
    }
